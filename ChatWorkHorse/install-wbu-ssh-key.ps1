...
$Key  = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMcGWYPg1fQx8rcSiY+J1ZhAozK1Dm8rzgb+lz6/o0BT wbu-to-chatworkhorse"
...
if ((Test-Path $File) -and (Select-String -Path $File -SimpleMatch -Pattern "wbu-to-chatworkhorse" -Quiet)) {
