...
# the fleet writer/metrics paths. Writer/vbs/server live in the scripts repo, so a
# repo box only needs the XMLs exported here.
# NOTE: amsterdamdesktop's repos live on D:\ — the repo probe below handles that.
