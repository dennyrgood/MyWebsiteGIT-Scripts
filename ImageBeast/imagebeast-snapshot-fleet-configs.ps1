# imagebeast-snapshot-fleet-configs.ps1
...
# references the fleet writer/metrics paths (catches the Heartbeat Writer task,
# which was not previously exported for imagebeast).
