<!--
  COPY. Canonical version is /NUT_CLIENT_SETUP.md at the repo root, which also
  covers ChatWorkhorseUnix. Duplicated here deliberately so it is found in this
  machine's own directory. If you change one, change all three.
-->
