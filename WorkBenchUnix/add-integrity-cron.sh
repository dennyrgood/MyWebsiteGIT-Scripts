...
echo "===== adding ====="
{
    ...
    echo "0 2 * * 0 $BASE/verify_immich_source_integrity.sh >/dev/null 2>>/var/log/immich-integrity.log"
    echo "0 2 15 * * $BASE/audit_mirror_checksums.sh fleetnas >/dev/null 2>>/var/log/mirror-audit.log"
    echo "40 2 15 * * $BASE/audit_mirror_checksums.sh macmini >/dev/null 2>>/var/log/mirror-audit.log"
